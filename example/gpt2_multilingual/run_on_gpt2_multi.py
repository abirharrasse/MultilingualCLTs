...
def main():
    ...
    train_batch_size_tokens = world_size * 768
    ...
    cfg = CLTTrainingRunnerConfig(
        ...
        seed=42,
        n_checkpoints=0,
        checkpoint_path="checkpoints/gpt2_multilingual",
        logger_verbose=True,
        ...
        cached_activations_path="/fast/fdraye/data/featflow/activations_gpt2_multilingual_70",
        ...
        log_to_wandb=True,
        wandb_project="gpt2-clt-multilingual-70",
        wandb_id=None,
