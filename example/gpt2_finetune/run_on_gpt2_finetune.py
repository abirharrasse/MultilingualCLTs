...
def main():
    ...
    total_training_steps = 10 // world_size # 125k steps at 16k batch size
    train_batch_size_tokens = world_size * 1280
    ...
    cfg = CLTTrainingRunnerConfig(
        from_pretrained_path="/home/fdraye/projects/featflow/checkpoints/gpt2/4vo05074/final_41600000",
