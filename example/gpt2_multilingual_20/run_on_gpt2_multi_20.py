...
MODEL_PERCENTAGE = sys.argv[1] if len(sys.argv) > 1 else "20"
...
def main():
    ...
    total_training_steps = 200_000 // world_size # 125k steps at 16k batch size
    ...
    l0_waiting_steps = 0
    l0_warm_up_steps = int(0.95 * total_training_steps) - l0_waiting_steps - 1 # warm up until the end of training
    ...
    cfg = CLTTrainingRunnerConfig(
        ...
        cached_activations_path="/fast/fdraye/data/featflow/activations_gpt2_multilingual_"+MODEL_PERCENTAGE,
        ...
        l0_coefficient=1.15, # was 1.2
        dead_penalty_coef=1e-4, # was 3e-4 before
