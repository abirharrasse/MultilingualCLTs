...
def print_activation_summary(results):
    ...
    print("\n" + "="*80)
    print("ACTIVATION SUMMARY - ALL CLUSTERS ACROSS ALL LANGUAGES")
    print("="*80)
    ...
    for cluster_name in sorted(all_cluster_names):
        print(f"\n{cluster_name}:")
        print(f"  {'Language':<15} {'Avg Activation':<15} {'Type'}")
        print(f"  {'-'*45}")
        ...
        for lang_name, lang_results in results.items():
            if cluster_name in lang_results:
                ...
                print(f"  {lang_name:<15} {data['avg_activation']:<15.6f} {type_str}")

def plot_cluster_activations_heatmap(results):
    """Create heatmap of average activations"""
    plt.rcParams.update({
        "font.size": 11,
        "pdf.fonttype": 42,
        "ps.fonttype": 42,
    ...
    cbar.set_label('Average Activation', fontweight='bold')
    ...
    ax.set_title('Cluster Activations Across Languages', fontweight='bold', pad=20)
    plt.tight_layout()
...
def plot_cluster_comparison_bars(results):
    ...
    for idx, cluster_name in enumerate(all_cluster_names):
        ...
        ax.set_ylabel('Average Activation', fontweight='bold')
...
if __name__ == "__main__":
    languages = {
        'English': {
            'pytorch_path':"/home/abir19/scratch/FeatFlow/example/graph/antonym_20_edge_log/en/attribution_graph.pt",
            'json_path': "/home/abir19/scratch/FeatFlow/src/featflow/attribution/antonym_20_en.json",
            'cluster_lists': [
                ["man&woman"],
                ["man multiling"]
            ]
        ...
        'French': {
            'pytorch_path': "/home/abir19/scratch/FeatFlow/example/graph/antonym_20_edge_log/fr/attribution_graph.pt",
            'json_path': "/home/abir19/scratch/FeatFlow/src/featflow/attribution/antonym_20_fr.json",
            'cluster_lists': [
                ["homme&femme"],
                ["homme"],
            ]
        ...
        'Arabic': {
            'pytorch_path': "/home/abir19/scratch/FeatFlow/example/graph/antonym_20_edge_log/ar/attribution_graph.pt", 
            'json_path': "/home/abir19/scratch/FeatFlow/src/featflow/attribution/antonym_20_ar.json",
            'cluster_lists': [
                [],
                ["rajol"],
            ]
        ...
        'German': {
            'pytorch_path': "/home/abir19/scratch/FeatFlow/example/graph/antonym_20_edge_log/de/attribution_graph.pt",
            'json_path': "/home/abir19/scratch/FeatFlow/src/featflow/attribution/antonym_20_ar.json",
            'cluster_lists': [
                [],
                [],
        ...
        'Chinese': {
            'pytorch_path': "/home/abir19/scratch/FeatFlow/example/graph/antonym_20_edge_log/zh/attribution_graph.pt",
            'json_path': "/home/abir19/scratch/FeatFlow/src/featflow/attribution/antonym_20_zh.json",
            'cluster_lists': [
                [],
                ["male"]
            ]
    ...
    with open('cluster_activation_results_20.json', 'w', encoding='utf-8') as f:
        json.dump(results, f, indent=2, ensure_ascii=False)
    print("\nSaved: cluster_activation_results_20.json")