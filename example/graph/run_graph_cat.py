...
def main():
    ...
    test_strings = [
        "كرة القدم، ركوب الدراجات، البيسبول كلها",
        "Football, cycling, baseball are all",
        "Football, cyclisme, baseball sont tous des",
        "Fußball, Radsport, Baseball sind alle",
        "足球、骑自行车、棒球都是"
    ]
    langs = ['ar', 'en', 'fr', 'de', 'zh']
    device = "cuda:0" if torch.cuda.is_available() else "cpu"
    folder_name = "/home/abir19/FeatFlow/example/graph/category_20"
