SYSTEM_PROMPT = (
    ...
    "pattern or concept the feature responds to. You should then provide an explanation in one sentence that explains this description. Sometimes, the role of a feature can only be determined by looking at adjacent tokens. Here are three examples: \n"
)
...
[EXPLANATION]: 'say a sport'. 
[Reasoning]: This feature activates on tokens that are preceded by a sport token.
"""
