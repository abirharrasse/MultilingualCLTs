SYSTEM_PROMPT = (
    ...
    "pattern or concept the feature responds to. You should then provide an explanation in one sentence that explains this description. "
    "These examples may be in different languages. You should ignore the language used, only focus on the content."
    "You should provide you answer in english. Sometimes, the role of a feature can only be determined by looking at adjacent tokens.\n"
)
...
[EXPLANATION]: This feature activates on tokens related to football and soccer.
"""
...
[DESCRIPTION]: After 'had'
[EXPLANATION]: This feature activates on words that come after the auxiliary verb "had".
"""
...
[DESCRIPTION]: Positive idioms
[EXPLANATION]: This feature activates on idiomatic expressions conveying positive emotional states.
"""
...
[EXPLANATION]: This feature activates on tokens that appear before sport related tokens.
"""
...
def generate_prompt_multilingual(highlighted_sequences: list[str], feat_layer: int, feat_idx: int) -> str:
    ...
    prompt = (
        ...
        "Begin your description with [DESCRIPTION] and your explanation with [EXPLANATION]:"
    )
